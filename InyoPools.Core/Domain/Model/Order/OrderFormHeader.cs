...
namespace InyoPools.Core.Domain.Model.Order
{
    using System;
    using System.ComponentModel.DataAnnotations;

    public class OrderFormHeader
    {
        public const string g_sDiscountFormat = " / {0} ";
        private const int g_iNumberOfDaysBeforeNoTracking = -180;
        [Key]
        ...
        public int OrderStatusID { get; set; } = (int)Enums.OrderStatus.InProgress;
        ...
        public string? BARoutingNumber { get; set; } = string.Empty;
        public string? BAAccountNumber { get; set; } = string.Empty;
